...
export class SyncCrossTeamProjectFlow1776694195000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "teams" DROP COLUMN IF EXISTS "team_focus"`);
        await queryRunner.query(`ALTER TABLE "teams" DROP COLUMN IF EXISTS "team_name"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "cross_team_assignment_requests" CASCADE`);
        await queryRunner.query(`ALTER TABLE "project_participants" DROP COLUMN IF EXISTS "cross_team_request_id"`);
        await queryRunner.query(`ALTER TABLE "project_participants" DROP COLUMN IF EXISTS "home_manager_id"`);
        await queryRunner.query(`ALTER TABLE "project_participants" DROP COLUMN IF EXISTS "assignment_type"`);
