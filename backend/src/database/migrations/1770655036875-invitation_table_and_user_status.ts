...
export class InvitationTableAndUserStatus1770655036875 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (!hasStatus) {
            ...
            await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "status" SET DEFAULT 'pending_invitation'`);
        }
        ...
        if (!(await queryRunner.hasColumn("users", "invited_by"))) await queryRunner.query(`ALTER TABLE "users" ADD "invited_by" character varying`);
        if (!(await queryRunner.hasColumn("users", "invited_at"))) await queryRunner.query(`ALTER TABLE "users" ADD "invited_at" TIMESTAMP`);
        if (!(await queryRunner.hasColumn("users", "activated_at"))) await queryRunner.query(`ALTER TABLE "users" ADD "activated_at" TIMESTAMP`);
        ...
        await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'users_role_enum') THEN CREATE TYPE "users_role_enum" AS ENUM('employee', 'team_manager', 'bid_manager'); END IF; END $$;`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "first_name" TYPE character varying`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "last_name" TYPE character varying`);
        ...
        // 9. Foreign Key
        await queryRunner.query(`ALTER TABLE "invitation_tokens" DROP CONSTRAINT IF EXISTS "FK_c0ec4a8975069154fa47924ce98"`);
        await queryRunner.query(`ALTER TABLE "invitation_tokens" ADD CONSTRAINT "FK_c0ec4a8975069154fa47924ce98" FOREIGN KEY ("user_id") REFERENCES "users"("user_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN IF EXISTS "invited_at"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN IF EXISTS "invited_by"`);
