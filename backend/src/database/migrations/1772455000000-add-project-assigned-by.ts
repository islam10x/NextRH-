...
export class AddProjectAssignedBy1772455000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "project_participants" DROP CONSTRAINT IF EXISTS "FK_project_participants_assigned_by"`);
        await queryRunner.query(`ALTER TABLE "project_participants" DROP COLUMN IF EXISTS "assigned_by"`);
    }
}
