...
%% ── Graphics & Figures ──────────────────────────────────────
\usepackage{graphicx}
\usepackage{grffile}   % allows spaces/dots in filenames
\usepackage{tikz}      % for curved background lines
\usepackage{float}
...
%% ════════════════════════════════════════════════════════════
%%  TITLE PAGE  (Horizon School style — matches official template)
%% ════════════════════════════════════════════════════════════
\begin{titlepage}
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \path[fill=primaryblue!80] 
    (current page.north west) -- ++(10,0) 
    to[out=180,in=90] ++(-10,-6) -- cycle;
  
  % Bottom right curved wave
  \path[fill=primaryblue!80] 
    (current page.south east) -- ++(-10,0) 
    to[out=0,in=270] ++(10,6) -- cycle;
\end{tikzpicture}

\begin{center}

%%── School header text ──────────────────────────────────────
  {\small\itshape École supérieure privée}\\[4pt]
  {\small\itshape Horizon des technologies numériques}\\[4pt]
  {\tiny $\blacklozenge$ \hspace{1pt} $\blacklozenge$ \hspace{1pt} $\blacklozenge$ \hspace{1pt} $\blacklozenge$ \hspace{1pt} $\blacklozenge$}\\[4pt]
  {\small N\textsuperscript{o} agrément : 2020/02}\\[4pt]
  {\tiny $\blacklozenge$ \hspace{1pt} $\blacklozenge$ \hspace{1pt} $\blacklozenge$ \hspace{1pt} $\blacklozenge$ \hspace{1pt} $\blacklozenge$}

  \vspace{0.8cm}

%%── School logo ─────────────────────────────────────────────
  \includegraphics[height=2.8cm]{figures/horizon_logo}

  \vspace{1.5cm}

%%── Report type ─────────────────────────────────────────────
  {\Huge Final Year Project Thesis}

  \vspace{0.8cm}
  {\small\bfseries Presented in partial fulfillment of the requirements for the}

  \vspace{0.6cm}
  {\Large\bfseries National Master's Degree In Professional Computer Science}

  \vspace{0.6cm}
  {\small Specialization :}\\[6pt]
  {\large\bfseries [Your Specialization Here]}

  \vspace{0.8cm}
  {\small\itshape By}\\[6pt]
  {\large\itshape [Your Full Name]}

  \vspace{0.8cm}

%%── Decorative rule + Title block + Decorative rule ────────
  {\color{primaryblue}\rule{0.6\linewidth}{1pt}}\\[16pt]
  {\LARGE\bfseries Design And Implementation Of An\\[8pt]
   [Your Project Title Here]}\\[16pt]
  {\color{primaryblue}\rule{0.6\linewidth}{1pt}}

  \vspace{0.8cm}
  {\small\itshape Defended On [DD/MM/YYYY] Before The Jury Composed Of:}
...
\begin{minipage}[t]{0.55\textwidth}
  \textbf{[Jury President Name]}\\[8pt]
  \textbf{[Reporter Name]}\\[8pt]
  \textbf{[Academic Supervisor Name]}\\[8pt]
  \textbf{[Professional Supervisor Name]}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.40\textwidth}\raggedleft
  President\\[8pt]
  Reporter\\[8pt]
  Academic Supervisor\\[8pt]
  Professional Supervisor
\end{minipage}

\vfill
\begin{center}
  \rule{2cm}{0.4pt}\quad{\small\itshape Academic Year : [YYYY] / [YYYY]}\quad\rule{2cm}{0.4pt}
\end{center}
